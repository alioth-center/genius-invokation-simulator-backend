...
type ModifierContext struct {
	addLocalDirectAttackModifiers kv.Map[uint64, []modifier.Modifier[DamageContext]]
	addLocalFinalAttackModifiers  kv.Map[uint64, []modifier.Modifier[DamageContext]]
	addLocalDefenceModifiers      kv.Map[uint64, []modifier.Modifier[DamageContext]]
	addLocalChargeModifiers       kv.Map[uint64, []modifier.Modifier[ChargeContext]]
	addLocalHealModifiers         kv.Map[uint64, []modifier.Modifier[HealContext]]
	addLocalCostModifiers         kv.Map[uint64, []modifier.Modifier[CostContext]]
	...
	removeLocalDirectAttackModifiers kv.Map[uint64, []modifier.Modifier[DamageContext]]
	removeLocalFinalAttackModifiers  kv.Map[uint64, []modifier.Modifier[DamageContext]]
	removeLocalDefenceModifiers      kv.Map[uint64, []modifier.Modifier[DamageContext]]
	removeLocalChargeModifiers       kv.Map[uint64, []modifier.Modifier[ChargeContext]]
	removeLocalHealModifiers         kv.Map[uint64, []modifier.Modifier[HealContext]]
	removeLocalCostModifiers         kv.Map[uint64, []modifier.Modifier[CostContext]]
...
func (m *ModifierContext) AddLocalDirectAttackModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) AddLocalFinalAttackModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) AddLocalDefenceModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) AddLocalChargeModifier(targetCharacter uint64, handler modifier.Modifier[ChargeContext]) {
	var null kv.Map[uint64, []modifier.Modifier[ChargeContext]] = nil
...
func (m *ModifierContext) AddLocalHealModifier(targetCharacter uint64, handler modifier.Modifier[HealContext]) {
	var null kv.Map[uint64, []modifier.Modifier[HealContext]] = nil
...
func (m *ModifierContext) AddLocalCostModifier(targetCharacter uint64, handler modifier.Modifier[CostContext]) {
	var null kv.Map[uint64, []modifier.Modifier[CostContext]] = nil
...
func (m *ModifierContext) RemoveLocalDirectAttackModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) RemoveLocalFinalAttackModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) RemoveLocalDefenceModifier(targetCharacter uint64, handler modifier.Modifier[DamageContext]) {
	var null kv.Map[uint64, []modifier.Modifier[DamageContext]] = nil
...
func (m *ModifierContext) RemoveLocalChargeModifier(targetCharacter uint64, handler modifier.Modifier[ChargeContext]) {
	var null kv.Map[uint64, []modifier.Modifier[ChargeContext]] = nil
...
func (m *ModifierContext) RemoveLocalHealModifier(targetCharacter uint64, handler modifier.Modifier[HealContext]) {
	var null kv.Map[uint64, []modifier.Modifier[HealContext]] = nil
...
func (m *ModifierContext) RemoveLocalCostModifier(targetCharacter uint64, handler modifier.Modifier[CostContext]) {
	var null kv.Map[uint64, []modifier.Modifier[CostContext]] = nil
...
func (m ModifierContext) AddLocalDirectAttackModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.addLocalDirectAttackModifiers
}

func (m ModifierContext) AddLocalFinalAttackModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.addLocalFinalAttackModifiers
}

func (m ModifierContext) AddLocalDefenceModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.addLocalDefenceModifiers
}

func (m ModifierContext) AddLocalChargeModifiers() kv.Map[uint64, []modifier.Modifier[ChargeContext]] {
	return m.addLocalChargeModifiers
}

func (m ModifierContext) AddLocalHealModifiers() kv.Map[uint64, []modifier.Modifier[HealContext]] {
	return m.addLocalHealModifiers
}

func (m ModifierContext) AddLocalCostModifiers() kv.Map[uint64, []modifier.Modifier[CostContext]] {
...
func (m ModifierContext) RemoveLocalDirectAttackModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.removeLocalDirectAttackModifiers
}

func (m ModifierContext) RemoveLocalFinalAttackModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.removeLocalFinalAttackModifiers
}

func (m ModifierContext) RemoveLocalDefenceModifiers() kv.Map[uint64, []modifier.Modifier[DamageContext]] {
	return m.removeLocalDefenceModifiers
}

func (m ModifierContext) RemoveLocalChargeModifiers() kv.Map[uint64, []modifier.Modifier[ChargeContext]] {
	return m.removeLocalChargeModifiers
}

func (m ModifierContext) RemoveLocalHealModifiers() kv.Map[uint64, []modifier.Modifier[HealContext]] {
	return m.removeLocalHealModifiers
}

func (m ModifierContext) RemoveLocalCostModifiers() kv.Map[uint64, []modifier.Modifier[CostContext]] {
